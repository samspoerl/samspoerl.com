      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="/carve-outs">Carve Outs</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
...
function DesktopNavigation(props: React.ComponentPropsWithoutRef<'nav'>) {
  return (
    <nav {...props}>
      <ul className="flex items-center rounded-full bg-white/90 px-3 text-sm font-medium whitespace-nowrap text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/">
          <HomeIcon size={16} />
        </NavItem>
        <NavItem href="/about">About</NavItem>
        <NavItem href="/projects">Projects</NavItem>
        <NavItem href="/carve-outs">Carve Outs</NavItem>
      </ul>
    </nav>
  )
}
...
// render, so `resolvedTheme` is already set by the time we hydrate while the
// server rendered nothing. The label has to stay generic until after hydration
// or the two disagree. useSyncExternalStore gives us that "are we hydrated yet"
// bit without a setState-in-effect and its extra render pass.
